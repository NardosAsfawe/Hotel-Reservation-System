...
<H1>Make a reservation:</H1> <H2> Input parameters: Hotel ID, guest’s name, start date, end date, room type, date of reservation, etc. Output:reservation ID (this is called confirmation code in real-life).</H2> 
...
<H1>Display a bill:</H1> <H2> Input parameters:reservation ID. Print on the console a bill for the guest. 
